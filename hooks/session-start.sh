...
if [ "$UNARCHIVED_INCREMENTS" -ge "$EVOLVE_THRESHOLD_SOFT" ]; then
  echo "[AI-CONTEXT] ${UNARCHIVED_INCREMENTS} unarchived increments found. Execute /evolve to compile snapshot and archive. This ensures your snapshot is up-to-date."
fi
